...
cached season data produced by research.run_backtest.

Usage:
    python -m research.run_advanced                         # Serie A 2024, history 2022+2023
    python -m research.run_advanced --league 39 --target-season 2024 --history 2023

Requires the relevant seasons already cached (run research.run_backtest for each first).
"""
...
def main():
    ...
    try:
        ...
        print("   Esegui prima:  python -m research.run_backtest --league "
